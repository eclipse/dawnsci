...
@Override
	 ...
	 */
	private void validateGroup_NXentry_XAS_data_reduction(final NXprocess group) throws Exception {
		// validate that the group is not null
	 ...
	 */
	private void validateGroup_NXentry_XAS_data_reduction_parameters(final NXparameters group) throws Exception {
		// validate that the group is not null
