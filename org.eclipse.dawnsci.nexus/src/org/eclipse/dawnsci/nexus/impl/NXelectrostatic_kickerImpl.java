...
public class NXelectrostatic_kickerImpl extends NXobjectImpl implements NXelectrostatic_kicker {
	...
	protected NXelectrostatic_kickerImpl(final NexusNodeFactory nodeFactory) {
		super(nodeFactory);
	}

	protected NXelectrostatic_kickerImpl(final long oid) {
		super(oid);
	}
	...
	public NXbaseClass getNXbaseClass() {
		return NXbaseClass.NX_ELECTROSTATIC_KICKER;
	}
