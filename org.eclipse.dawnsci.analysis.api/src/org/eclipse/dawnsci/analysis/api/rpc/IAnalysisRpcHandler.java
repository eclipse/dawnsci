 ...
 * {@link IAnalysisRpcServer#addHandler(String, IAnalysisRpcHandler)}
 * <p>
 * Consider using one of the provided implementations of {@link IAnalysisRpcHandler} which can delegate to a class:
 * <ul>
 * <li>AnalysisRpcGenericInstanceDispatcher for dispatching to all instance methods in a class</li>
 * <li>AnalysisRpcGenericStaticClassDispatcher for dispatching to all static methods in a class</li>
